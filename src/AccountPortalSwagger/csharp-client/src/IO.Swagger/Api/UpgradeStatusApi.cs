...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IUpgradeStatusApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class UpgradeStatusApi : IUpgradeStatusApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="UpgradeStatusApi"/> class.
        /// </summary>
        /// <returns></returns>
        public UpgradeStatusApi(String basePath)
        {
        ...
        /// <returns></returns>
        public UpgradeStatusApi(Configuration configuration = null)
        {
