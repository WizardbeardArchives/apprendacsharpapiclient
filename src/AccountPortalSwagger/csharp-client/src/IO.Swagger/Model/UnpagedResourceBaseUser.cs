...
{
    /// <summary>
    /// UnpagedResourceBaseUser
    /// </summary>
    [DataContract]
    public partial class UnpagedResourceBaseUser :  IEquatable<UnpagedResourceBaseUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnpagedResourceBaseUser" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnpagedResourceBaseUser() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnpagedResourceBaseUser" /> class.
        /// </summary>
        /// <param name="Href">Href.</param>
        /// <param name="Items">Items (required).</param>
        public UnpagedResourceBaseUser(string Href = default(string), List<User> Items = default(List<User>))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for UnpagedResourceBaseUser and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnpagedResourceBaseUser {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UnpagedResourceBaseUser);
        }

        /// <summary>
        /// Returns true if UnpagedResourceBaseUser instances are equal
        /// </summary>
        /// <param name="other">Instance of UnpagedResourceBaseUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnpagedResourceBaseUser other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
