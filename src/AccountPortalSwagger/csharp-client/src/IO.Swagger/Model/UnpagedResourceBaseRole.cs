...
{
    /// <summary>
    /// UnpagedResourceBaseRole
    /// </summary>
    [DataContract]
    public partial class UnpagedResourceBaseRole :  IEquatable<UnpagedResourceBaseRole>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnpagedResourceBaseRole" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnpagedResourceBaseRole() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnpagedResourceBaseRole" /> class.
        /// </summary>
        ...
        public UnpagedResourceBaseRole(string Href = default(string), List<Role> Items = default(List<Role>))
        {
            ...
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for UnpagedResourceBaseRole and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnpagedResourceBaseRole {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UnpagedResourceBaseRole);
        }

        /// <summary>
        /// Returns true if UnpagedResourceBaseRole instances are equal
        /// </summary>
        /// <param name="other">Instance of UnpagedResourceBaseRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnpagedResourceBaseRole other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
