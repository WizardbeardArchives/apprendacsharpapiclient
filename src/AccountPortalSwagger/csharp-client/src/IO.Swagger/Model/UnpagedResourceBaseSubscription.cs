...
{
    /// <summary>
    /// UnpagedResourceBaseSubscription
    /// </summary>
    [DataContract]
    public partial class UnpagedResourceBaseSubscription :  IEquatable<UnpagedResourceBaseSubscription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnpagedResourceBaseSubscription" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnpagedResourceBaseSubscription() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnpagedResourceBaseSubscription" /> class.
        /// </summary>
        ...
        public UnpagedResourceBaseSubscription(string Href = default(string), List<Subscription> Items = default(List<Subscription>))
        {
            ...
            if (Href == null)
            {
                throw new InvalidDataException("Href is a required property for UnpagedResourceBaseSubscription and cannot be null");
            }
            else
            {
                this.Href = Href;
            ...
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for UnpagedResourceBaseSubscription and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnpagedResourceBaseSubscription {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UnpagedResourceBaseSubscription);
        }

        /// <summary>
        /// Returns true if UnpagedResourceBaseSubscription instances are equal
        /// </summary>
        /// <param name="other">Instance of UnpagedResourceBaseSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnpagedResourceBaseSubscription other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
