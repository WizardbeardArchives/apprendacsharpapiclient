...
namespace IO.Swagger.Model
{
    ...
    public partial class UpgradeStatus :  IEquatable<UpgradeStatus>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="UpgradeStatus" /> class.
        /// </summary>
        /// <param name="UpgradeInProgress">UpgradeInProgress (required) (default to false).</param>
        public UpgradeStatus(bool? UpgradeInProgress = false)
        {
            // to ensure "UpgradeInProgress" is required (not null)
            if (UpgradeInProgress == null)
            {
                throw new InvalidDataException("UpgradeInProgress is a required property for UpgradeStatus and cannot be null");
            }
            else
            {
