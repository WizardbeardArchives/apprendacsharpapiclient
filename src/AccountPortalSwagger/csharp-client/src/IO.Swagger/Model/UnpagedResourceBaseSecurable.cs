...
{
    /// <summary>
    /// UnpagedResourceBaseSecurable
    /// </summary>
    [DataContract]
    public partial class UnpagedResourceBaseSecurable :  IEquatable<UnpagedResourceBaseSecurable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnpagedResourceBaseSecurable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnpagedResourceBaseSecurable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnpagedResourceBaseSecurable" /> class.
        /// </summary>
        /// <param name="Href">Href.</param>
        /// <param name="Items">Items (required).</param>
        public UnpagedResourceBaseSecurable(string Href = default(string), List<Securable> Items = default(List<Securable>))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for UnpagedResourceBaseSecurable and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<Securable> Items { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnpagedResourceBaseSecurable {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UnpagedResourceBaseSecurable);
        }

        /// <summary>
        /// Returns true if UnpagedResourceBaseSecurable instances are equal
        /// </summary>
        /// <param name="other">Instance of UnpagedResourceBaseSecurable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnpagedResourceBaseSecurable other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
