...
namespace ApprendaAPIClient.Models.DeveloperPortal
{
    ...
    public partial class Cloud :  IEquatable<Cloud>, IValidatableObject
    {
        ...
        public Cloud(string Description = default(string), string RootUrl = default(string), string Name = default(string), string Href = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Cloud);
        }
        ...
        public bool Equals(Cloud other)
        {
            ...
            return 
                ...
                (
                    this.RootUrl == other.RootUrl ||
                    this.RootUrl != null &&
                    this.RootUrl.Equals(other.RootUrl)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RootUrl != null)
                    hash = hash * 59 + this.RootUrl.GetHashCode();
                if (this.Name != null)
