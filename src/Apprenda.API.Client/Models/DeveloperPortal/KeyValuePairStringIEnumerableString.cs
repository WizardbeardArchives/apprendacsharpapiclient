...
namespace ApprendaAPIClient.Models.DeveloperPortal
{
    ...
    public partial class KeyValuePairStringIEnumerableString :  IEquatable<KeyValuePairStringIEnumerableString>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyValuePairStringIEnumerableString" /> class.
        /// </summary>
        /// <param name="Value">Value.</param>
        public KeyValuePairStringIEnumerableString(List<string> Value = default(List<string>))
        {
            this.Value = Value;
        }
